      ...
      <div class="card-wrapper">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              <label class="form-control-label" for="production_date">Tanggal Produksi: <?php echo set_value('production_date', $product->production_date); ?></label>
              <input type="date" name="production_date" value="<?php echo set_value('production_date', $product->production_date); ?>" class="form-control" id="production_date">
              <?php echo form_error('production_date'); ?>


              <div class="form-group">
                <label class="form-control-label" for="expired_date">Tanggal Expired: <?php echo set_value('expired_date', $product->expired_date); ?></label>
                <input type="date" name="expired_date" value="<?php echo set_value('expired_date', $product->expired_date); ?>" class="form-control" id="expired_date">
